...
class LoadingPopup(context: Context) : Dialog(context) {
    ...
    private fun setupBackgroundColorWithOpacity() {
        ...
        if (backgroundColor == android.R.color.transparent)
            vContent.setBackgroundColor(
                Color.parseColor(
                    ColorTransparentUtils
    ...
    class LoadingBuilder(activity: Activity) : FinalStep, TypeStep, DelayDurationStep, DelayStep,
        CustomLayoutStep {
